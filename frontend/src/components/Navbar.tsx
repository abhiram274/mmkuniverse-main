    ...
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-mmk-dark/80 border-b border-white/10">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/home" className="flex items-center">
                  <span className="text-2xl flex items-center font-bold text-gradient-primary">{userName}</span>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/events" className="text-gray-300 hover:text-white transition">Events</Link>
            <Link to="/my_profile" className="text-gray-300 hover:text-white transition ">My Profile</Link>
          ...
          {/* <Link to="/login" className="text-gray-300 hover:text-white transition">Logout</Link> */}
          <Link to="/logout">
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-mmk-dark z-50 shadow-lg">
          <div className="flex flex-col space-y-4 p-4">
            ...
            <Link to="/my_profile" className="text-gray-300 hover:text-white transition py-2">My Profile</Link>
